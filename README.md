...
A script to automate all steps neded to install https://github.com/hardware/mailserver (Simple and full-featured mail server using Docker) on a digitalocean droplet
